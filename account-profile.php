            ...
            <div class="bg-white rounded-3 shadow-lg pt-1 mb-5 mb-lg-0">
              ...
              <div class="d-lg-block collapse" id="account-menu">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3 active" href="account-profile.php"><i class="ci-user opacity-60 me-2"></i>Thông tin tài khoản</a></li>
            ...
            <form class="needs-validation" novalidate method="post">
              ...
              <div class="row gx-4 gy-3">
                <div class="col-sm-6">
                  ...
                  <input required name="first_name" class="form-control" type="text" id="account-fn" value="<?php echo htmlspecialchars($user['first_name'])?>">
                  <div class="invalid-feedback">Vui lòng nhập họ và tên đệm!</div>
                </div>
                <div class="col-sm-6">
                  <label class="form-label" for="account-ln">Tên</label>
                  <input required name="last_name" class="form-control" type="text" id="account-ln" value="<?php echo htmlspecialchars($user['last_name'])?>">
                ...
                <div class="col-sm-6">
                  ...
                  <input class="form-control" name="phone_number" type="text" id="account-phone" value="<?php echo htmlspecialchars($user['phone_number'])?>" required>
                </div>
                <div class="col-sm-6">
