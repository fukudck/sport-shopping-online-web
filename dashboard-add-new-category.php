          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            <div class="pt-2 px-4 ps-lg-0 pe-xl-5">
              ...
              <div class="d-sm-flex flex-wrap justify-content-between align-items-center pb-2">
                <h2 class="h3 py-2 me-2 text-center text-sm-start">Thêm danh mục</h2>
              </div>
              <form action="admin/php/addCategory.php" method="POST" enctype="multipart/form-data">
                <div class="mb-3 pb-2">
                  <label class="form-label" for="unp-category-name">Tên Danh Mục</label>
                  <input class="form-control" type="text" id="unp-category-name" name="category_name">
                </div>
                <div class="mb-3 pb-2">
                  <div class="py-2">
                    <label class="form-label" for="unp-parent-category">Danh Mục Cha</label>
                ...
                <div class="file-drop-area mb-3">
                  ...
                  <span class="file-drop-message">Tải ảnh lên</span>
                  <input class="file-drop-input" type="file" name="category_image">
                  <button class="file-drop-btn btn btn-primary btn-sm mb-2" type="button">Hoặc chọn file...</button>
                ...
                <button class="btn btn-primary d-block w-100" type="submit" name="submit">
                  <i class="ci-cloud-upload fs-lg me-2"></i>Thêm Danh Mục
                </button>
              </form>
            </div>
          </section>
